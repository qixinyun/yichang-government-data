...
class XzcjTemplate implements ITemplate
{
	const TEMPLATE = array(
	    ...
	    array('englishName'=>'lb', 'name'=>'行政裁决种类'),
	    array('englishName'=>'nr', 'name'=>'行政裁决内容'),
	    array('englishName'=>'rq', 'name'=>'行政裁决日期'),
	    array('englishName'=>'jg', 'name'=>'行政裁决机关'),
