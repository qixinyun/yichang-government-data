...
class XzjfTemplate implements ITemplate
{
	const TEMPLATE = array(
	    ...
	    array('englishName'=>'lb', 'name'=>'行政给付类型'),
	    array('englishName'=>'nr', 'name'=>'行政给付内容'),
	    array('englishName'=>'rq', 'name'=>'行政给付日期'),
	    array('englishName'=>'jg', 'name'=>'行政给付决定机关'),
