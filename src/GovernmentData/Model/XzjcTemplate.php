...
class XzjcTemplate implements ITemplate
{
	const TEMPLATE = array(
	    ...
	    array('englishName'=>'lb', 'name'=>'行政检查形式'),
	    array('englishName'=>'nr', 'name'=>'行政检查内容'),
	    array('englishName'=>'rq', 'name'=>'行政检查日期'),
	    array('englishName'=>'jg', 'name'=>'行政检查机关'),
