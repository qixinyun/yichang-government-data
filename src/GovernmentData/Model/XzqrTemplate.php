...
class XzqrTemplate implements ITemplate
{
	const TEMPLATE = array(
	    ...
	    array('englishName'=>'lb', 'name'=>'确认形式'),
	    array('englishName'=>'nr', 'name'=>'行政确认内容'),
	    array('englishName'=>'rq', 'name'=>'确认日期'),
	    array('englishName'=>'jg', 'name'=>'确认机关'),
