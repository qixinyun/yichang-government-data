...
class XzzsTemplate implements ITemplate
{
	const TEMPLATE = array(
	    ...
	    array('englishName'=>'lb', 'name'=>'行政征收种类'),
	    array('englishName'=>'nr', 'name'=>'行政征收内容'),
	    array('englishName'=>'rq', 'name'=>'行政征收日期'),
	    array('englishName'=>'jg', 'name'=>'行政征收机关'),
