...
class XzqzTemplate implements ITemplate
{
	const TEMPLATE = array(
	    ...
	    array('englishName'=>'lb', 'name'=>'行政强制形式'),
	    array('englishName'=>'nr', 'name'=>'行政强制实施内容'),
	    array('englishName'=>'rq', 'name'=>'决定日期'),
	    array('englishName'=>'jg', 'name'=>'决定机关'),
