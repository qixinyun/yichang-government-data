...
class XzxkTemplate implements ITemplate
{
	const TEMPLATE = array(
	    ...
	    array('englishName'=>'wh', 'name'=>'行政许可决定书文号或证书编号'),
	    array('englishName'=>'mc', 'name'=>'项目名称'),
	    array('englishName'=>'lb', 'name'=>'审批类别'),
	    array('englishName'=>'nr', 'name'=>'许可内容'),
	    array('englishName'=>'rq', 'name'=>'许可生效期'),
	    array('englishName'=>'jzq', 'name'=>'许可截止期'),
	    array('englishName'=>'jg', 'name'=>'许可机关'),
