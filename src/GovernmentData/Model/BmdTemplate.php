...
class BmdTemplate implements ITemplate
{
	const TEMPLATE = array(
	    ...
	    array('englishName'=>'rq', 'name'=>'认定日期'),
	    array('englishName'=>'jzq', 'name'=>'截止期'),
	    array('englishName'=>'gsqx', 'name'=>'公示期限(月)'),
	    array('englishName'=>'jg', 'name'=>'认定机关'),
	    array('englishName'=>'jgbm', 'name'=>'认定机关行政区域码'),
