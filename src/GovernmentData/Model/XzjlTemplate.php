...
class XzjlTemplate implements ITemplate
{
	const TEMPLATE = array(
	    ...
	    // array('englishName'=>'frzjlx', 'name'=>'法人身份证件类型'),
	    // array('englishName'=>'frzjhm', 'name'=>'法人身份证件号码'),
	    array('englishName'=>'lb', 'name'=>'奖励形式'),
	    array('englishName'=>'nr', 'name'=>'奖励内容'),
	    array('englishName'=>'rq', 'name'=>'奖励授予日期'),
	    array('englishName'=>'jzq', 'name'=>'有效截止期'),
	    array('englishName'=>'jg', 'name'=>'授予机构'),
