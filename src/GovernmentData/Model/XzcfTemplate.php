...
class XzcfTemplate implements ITemplate
{
	const TEMPLATE = array(
	    ...
	    array('englishName'=>'wh', 'name'=>'行政处罚决定书文号'),
	    array('englishName'=>'mc', 'name'=>'案件名称'),
	    array('englishName'=>'lb', 'name'=>'处罚类别'),
	    array('englishName'=>'nr', 'name'=>'处罚事由或主要违法事实'),
	    array('englishName'=>'yj', 'name'=>'处罚依据'),
	    array('englishName'=>'jieguo', 'name'=>'处罚结果'),
	    array('englishName'=>'rq', 'name'=>'处罚生效期'),
	    array('englishName'=>'jzq', 'name'=>'处罚截止期'),
	    array('englishName'=>'jg', 'name'=>'处罚机构'),
	    array('englishName'=>'zt', 'name'=>'当前状态'),
