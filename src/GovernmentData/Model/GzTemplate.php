...
class GzTemplate implements ITemplate
{
	const TEMPLATE = array(
	    ...
	    array('englishName'=>'nr', 'name'=>'信息内容'),
	    array('englishName'=>'rq', 'name'=>'信息提供日期'),
	    array('englishName'=>'tgrxm', 'name'=>'信息提供人姓名'),
	    // array('englishName'=>'tgrzjlx', 'name'=>'信息提供人证件类型'),
	    // array('englishName'=>'tgrzjhm', 'name'=>'信息提供人证件号码'),
